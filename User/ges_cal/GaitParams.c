...
const float step_length=6; //正常站立高度时的步长
const float up_amp=3;  //腿的上摆
...
GaitParams gait_params[][4] = {
  //	Up_Amp Down_Amp stanceheight steplength freq swingpercent gaitoffset i x_offset
	...
	//0，1是后腿
	// {//Normal 0
	// 	{ up_amp, 0.2, StandHeight, step_length, Freq, 0.5, 0, 0,X_OFFSET},
	// 	{ up_amp, 0.2, StandHeight, step_length, Freq, 0.5, 0.5, 1,X_OFFSET},
	// 	{ up_amp, 0.2, StandHeight, step_length, Freq, 0.5, 0.5, 2,X_OFFSET},
	// 	{ up_amp, 0.2, StandHeight, step_length, Freq, 0.5, 0, 3,X_OFFSET},
	// },
	// {//停止	1
	...
	// 	{ up_amp, 0.2, StandHeight+2.5, 0, Freq*1.5, 0.5, 0, 1,X_OFFSET},
	// 	{ up_amp, 0.2, StandHeight, 0, Freq*1.5, 0.5, 0.5, 2,X_OFFSET},
	// 	{ up_amp, 0.2, StandHeight+2.5, 0, Freq*1.5, 0.5, 0, 3,X_OFFSET},
	// },
	// {//右平移 3
	// 	{ up_amp, 0.2, StandHeight+2.5, 0, Freq*1.5, 0.5, 0.5, 0,X_OFFSET},
	// 	{ up_amp, 0.2, StandHeight, 0, Freq*1.5, 0.5, 0, 1,X_OFFSET},
	// 	{ up_amp, 0.2, StandHeight+2.5, 0, Freq*1.5, 0.5, 0.5, 2,X_OFFSET},
	...
	{//左平移 2
		{ up_amp, 0.2, StandHeight+2.5, 0, 	4.2,	0.35, 	0, 0,X_OFFSET},
		{ up_amp, 0.2, StandHeight+2.5, 0, 	4.2,	0.35,	0, 1,X_OFFSET},
		{ up_amp, 0.2, StandHeight, 	0,	4.2,	0.35, 	0.5, 2,X_OFFSET},
		{ up_amp, 0.2, StandHeight, 	0,	4.2,	0.35,	0.5, 3,X_OFFSET},
	},
	{//右平移 3
		{ up_amp, 0.2, StandHeight, 	0,	4.2,	0.35,	0.5, 0,X_OFFSET},
		{ up_amp, 0.2, StandHeight, 	0,	4.2,	0.35,	0.5, 1,X_OFFSET},
		{ up_amp, 0.2, StandHeight+2.5, 0, 	4.2,	0.35,	0, 2,X_OFFSET},
		{ up_amp, 0.2, StandHeight+2.5, 0, 	4.2,	0.35,	0, 3,X_OFFSET},
	},
...
{
	//left legs
	gaitparams[2].steplength=gaitparams[2].stanceheight*0.44;
	gaitparams[3].steplength=gaitparams[3].stanceheight*0.44;
	//right legs
	gaitparams[0].steplength=gaitparams[0].stanceheight*0.44;
	gaitparams[1].steplength=gaitparams[1].stanceheight*0.44;
