...
const u8 zh14x14[][32] = {
/* 0 翔 */ {0xe7,0xbf,0x94,0x00,0x84,0x95,0x96,0xfc,0x96,0x95,0x00,0x8a,0x52,0xfe,0x8a,0x52,0xfe,0x00,0x10,0x08,0x06,0x01,0x00,0x00,0x00,0x08,0x10,0x0f,0x08,0x10,0x0f,0x00,},
/* 1 鸡 */ {0xe9,0xb8,0xa1,0x00,0x14,0x24,0xc4,0x3c,0x00,0x00,0x7e,0x42,0x5b,0x62,0x5e,0x40,0xc0,0x00,0x04,0x03,0x00,0x03,0x00,0x01,0x01,0x01,0x01,0x09,0x11,0x08,0x07,0x00,}
};
const Font_t font14x14 = {.w =14, .h = 14, .chars = (const u8 *)zh14x14,.len = sizeof(zh14x14)/32, .ascii = &afont16x8};
//circle
const u8 circleData[] = {
0xff, 0xff, 0xff,0xff
};
const Image_t circleImg = {4, 4, circleData};
// Rocker
const u8 rockerData[] = {
...
const Image_t rockerImg = {24, 24, rockerData};

const u8 buttomData[] = {
0xff, 0xe1, 0xe1, 0xe1, 0xe1, 0xff, 
};
const Image_t buttomImg = {6, 6, buttomData};
